            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-4">
                    <p class="text-l text-gray-600">
                        {{ $classrooms->count() }} {{ Str::plural('Classroom', $classrooms->count()) }}
                    </p>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($classrooms as $classroom)
                            <tr>
                                ...
                                <td class="px-4 py-3">{{ $classroom->teachers_count }}</td>
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form action="{{ route('classrooms.destroy', $classroom) }}" method="POST"
                                            onsubmit="return confirm('Deleting this classroom will permanently delete all students and teachers assigned to it. This cannot be undone. Continue?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-6 text-center text-gray-500">No classrooms yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
